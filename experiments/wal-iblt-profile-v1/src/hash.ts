...
export function deriveReconciliationSeed(
  ...
  return hashBytes(DOMAIN.seed, requesterHeadId, providerHeadId, requesterNonce);
}

export function idChecksum(reconciliationSeed: Uint8Array, walObjectId: Uint8Array): Uint8Array {
...
export function idMappingSeed(reconciliationSeed: Uint8Array, walObjectId: Uint8Array): bigint {
  assertLength(reconciliationSeed, 32, 'reconciliationSeed');
  assertLength(walObjectId, WAL_OBJECT_ID_LENGTH, 'walObjectId');
