...
**Related**: [SPEC_V10_IDENTITY_AND_ACCESS.md](./SPEC_V10_IDENTITY_AND_ACCESS.md), [Context Graphs](../../docs/how-dkg-works/context-graphs.md), and [Knowledge Assets](../../docs/how-dkg-works/knowledge-assets.md).
