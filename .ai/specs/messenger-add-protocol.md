...
rc.9 — see [`docs/how-dkg-works/universal-messenger.md` "Wire format"](../../docs/how-dkg-works/universal-messenger.md#wire-format)
...
Add a row to the table in [`docs/how-dkg-works/universal-messenger.md` § "Per-protocol coverage"](../../docs/how-dkg-works/universal-messenger.md#per-protocol-coverage):
...
- `docs/how-dkg-works/universal-messenger.md` — "Per-protocol coverage" row added /
  refined.
