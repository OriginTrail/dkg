...
function sameContextGraphNameHashSlotScope(
...
function copyContextGraphNameHashSlotScope(
...
function cloneContextGraphNameHashIdsByHash(
...
function appendContextGraphNameHashSlots(
