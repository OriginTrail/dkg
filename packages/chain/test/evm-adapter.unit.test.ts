...
// under a degraded primary despite healthy backups. These drive the REAL
// readContract failover through `createOnChainContextGraph` (bare-provider
// doubles, mirroring the C6 pattern above).
