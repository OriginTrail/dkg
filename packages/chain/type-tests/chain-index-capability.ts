...
import { createEvmChainIndexRuntime, type EvmChainIndexRuntimeOptions } from '../src/index.js';
...
const dualOwner: EVMAdapterConfig = { ...common, chainIndex: { store }, chainEventLogStore: store };
// @ts-expect-error A legacy reader cannot exist independently of a capability.
const legacyReaderOnly: EVMAdapterConfig = { ...common, chainEventLogReadModelFactory: readModelFactory };
...
const structuralLegacyReader: EVMAdapterConfig = legacyReaderVariable;
