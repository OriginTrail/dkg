...
describe('canonical CBOR reconciliation symbol tuple', () => {
  ...
  it('rejects malformed, non-canonical, truncated, and trailing encodings', () => {
    ...
    const cases: Array<[Uint8Array, string]> = [
      [new Uint8Array(), 'MALFORMED_SYMBOL'],
      [Uint8Array.of(0x83), 'MALFORMED_SYMBOL'],
      [Uint8Array.of(0x84, 0x9f), 'MALFORMED_SYMBOL'],
      [Uint8Array.of(0x84, 0x18, 0x00), 'NON_CANONICAL_SYMBOL'],
      [Uint8Array.of(0x84, 0x19, 0x00, 0xff), 'NON_CANONICAL_SYMBOL'],
      [Uint8Array.of(0x84, 0x1a, 0x00, 0x00, 0xff, 0xff), 'NON_CANONICAL_SYMBOL'],
      [Uint8Array.of(0x84, 0x1b, 0, 0, 0, 0, 0xff, 0xff, 0xff, 0xff), 'NON_CANONICAL_SYMBOL'],
      [Uint8Array.of(0x84, 0x1f), 'MALFORMED_SYMBOL'],
      [Uint8Array.of(0x84, 0x40), 'MALFORMED_SYMBOL'],
      [Uint8Array.of(0x84, 0x00, 0x40), 'MALFORMED_SYMBOL'],
      [Uint8Array.of(0x84, 0x00, 0x00, 0x00), 'MALFORMED_SYMBOL'],
      [Uint8Array.of(0x84, 0x00, 0x00, 0x57), 'MALFORMED_SYMBOL'],
      [Uint8Array.of(0x84, 0x00, 0x00, 0x58, 0x20), 'MALFORMED_SYMBOL'],
