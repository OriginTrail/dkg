...
try {
  ...
  const card = page.locator(".nsmx .mcard .name", { hasText: /14B/ });
  await card.waitFor({ timeout: 60_000 });
  step("J5", "catalog card for okf 14B (direct seller)", true, {});
  ...
  step("J7", "STREAMED completion over direct HTTP - frames live, verified after final recount", true, {});
