// GENERATED from docs/ui-spec/UI-COPY.md — do not edit; run nsm:sync.
...
export const COPY: Record<string, string> = {
  ...
  "withhold.bytes": "What we received doesn't match what was billed — payment blocked",
  "withhold.recount": "The token count doesn't add up — payment blocked",
  "withhold.tokenizer": "Billed with a different tokenizer than promised — payment blocked",
  "withhold.overbill": "Charged above the agreed price — payment blocked",
  "withhold.signature": "The bill isn't properly signed — payment blocked",
...
export const WITHHOLD_CODE: Record<string, string> = {
  "withhold.bytes": "E_BYTES_DIGEST",
  "withhold.recount": "E_RECOUNT_MISMATCH",
  "withhold.tokenizer": "E_TOKENIZER_DRIFT",
  "withhold.overbill": "E_OVERBILL",
  "withhold.signature": "E_LEG_SIGNATURE"
};
