...
export function sharedMemoryDiagnostics(overrides: Partial<Diagnostics['sharedMemory']> = {}): Diagnostics['sharedMemory'] {
  return {
    ...
    deferredBackpressure: 0, deniedPhases: 0, backoffWorthyFailures: 0,
    snapshotPlaneIncomplete: 0, metadataContinuationYields: 0, continuationPasses: 0,
    resolvedSnapshotPlaneIncomplete: 0, resolvedMetadataContinuationYields: 0,
