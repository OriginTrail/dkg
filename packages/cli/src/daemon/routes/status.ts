...
import { resolveRpcUrls, getRpcFailoverStats } from '@origintrail-official/dkg-chain';
import { DKGAgent, resolveSyncReconcilerEnabled } from '@origintrail-official/dkg-agent';
import {
