...
`;
  ...
  const server = createServer(async (req, res) => {
    try {
      ...
      // Inject the auth token into app HTML so the app's JS can call the node API.
      // Apps at /apps/* are public paths — they're installed on this node and need API access.
