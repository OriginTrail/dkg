...
import type { CatchupPhaseProgress, CatchupPlaneCompletionEvidence } from './catchup-proof.js';
...
export type { CatchupPhaseProgress, CatchupPlaneCompletionEvidence, CatchupPlaneRoundDiagnostics } from './catchup-proof.js';
