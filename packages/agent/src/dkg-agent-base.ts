...
export class DKGAgentBase {
  ...
  /** Optional daemon-local authority-index scheduling capability. */
  protected readonly contextGraphAuthorityIndexRevisionReader:
