...
export const RFC64_FINALIZED_PRIVATE_PLACEMENT_REPAIR_STORE_DIRECTORY_NAME_V1 =
  'finalized-private-placement-repairs-v1' as const;
...
export const RFC64_FINALIZED_PRIVATE_PLACEMENT_REPAIR_STORE_RELATIVE_PATH =
  `${RFC64_PERSISTENCE_ROOT_RELATIVE_PATH_V1}/${RFC64_FINALIZED_PRIVATE_PLACEMENT_REPAIR_STORE_DIRECTORY_NAME_V1}` as const;
...
export function resolveRfc64FinalizedPrivatePlacementRepairStorePathV1(
