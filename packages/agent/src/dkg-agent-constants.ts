...
// #1404 — attempts for retryTransientPolicyState (behind resolvePublishAccessPolicyState):
// a single CHAIN_POLICY_READ_TIMEOUT_MS (2.5s) miss on a slow chain RPC yields a
// transient 'unknown' that a couple of bounded retries turn into a CONFIRMED
// policy, without weakening the fail-closed contract.
