...
import {
  ...
  Logger, createOperationContext, logKaLifecycleEvent, escapeSparqlLiteral, isSafeIri, assertSafeIri,
  TrustLevel,
      ...
      logLifecycle: (event) => {
        logKaLifecycleEvent(this.log, ctx, {
          ...
          metadata: {
            ...
            fetchedDataCount: event.fetchedDataCount,
            insertedMetaCount: event.insertedMetaCount,
            insertedDataCount: event.insertedDataCount,
            rejectedKcs: event.rejectedKcs,
            reason: event.reason,
          },
        });
      },
