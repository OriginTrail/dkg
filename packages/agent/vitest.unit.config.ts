...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      "test/peer-capability.test.ts",
      "test/ack-candidate-discovery.test.ts",
      ...
      "test/sync-protocol-peer-id.test.ts",
      "test/random-sampling-membership.test.ts",
      "test/random-sampling-handle-compatibility.test.ts",
      ...
      "test/manifest-resume-policy.test.ts",
      ...
      "test/context-graph-name-adoption.test.ts",
      "test/context-graph-name-hash-subscription.integration.test.ts",
