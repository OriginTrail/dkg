...
import {
  buildRfc64PrivateReleaseArtifactV2,
  hasExactMemoryContents,
} from '../devnet/rfc64-private-catalog/scenario-artifact.mjs';
...
describe('RFC-64 private release gate persisted PASS decoder', () => {
  it('rejects a legacy V1 artifact before interpreting its incompatible provenance', () => {
    const current = persistedScenarioPass();
    const artifact = {
      ...current,
      schema: 'dkg-rfc64-private-release-gate-v1',
      runtimeProvenance: {
        schema: 'dkg-rfc64-private-runtime-provenance-v1',
        sourceBuild: current.runtimeProvenance.sourceBuild,
        processes: current.runtimeProvenance.processes.map(({ id }) => ({
          id,
          loaded: buildExecutedRuntimeManifestV1(
            current.sourceRevision,
            current.runtimeProvenance.sourceBuild.runtimeFiles,
          ),
        })),
      },
    };
    expect(() => decodeRfc64PrivateGatePassArtifactV2(artifact))
      .toThrow(/invalid schema or status/u);
  });
  ...
  it('decodes only the closed all-true PASS contract with substantiated denials', () => {
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(unknownTopLevel))
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(missingTopLevel))
      .toThrow(/unknown or missing fields/u);

    const falseCheck = structuredClone(artifact);
    falseCheck.checks.outsiderDeniedBeforeApplication = false;
    expect(() => decodeRfc64PrivateGatePassArtifactV2(falseCheck))
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(unknownCheck))
      .toThrow(/unknown or missing fields/u);

    const outsiderApplied = structuredClone(artifact);
    outsiderApplied.outsider.appliedHeadDigest = `0x${'1'.repeat(64)}`;
    expect(() => decodeRfc64PrivateGatePassArtifactV2(outsiderApplied))
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(outsiderMaterialized))
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(untypedOutsiderDenial))
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(unobservedRevocation))
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(mismatchedRevokedAgent))
      .toThrow(/authority evidence is inconsistent/u);
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(advancedProviderRoster))
      .toThrow(/authority evidence is inconsistent/u);
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(rolledBackProviderRoster))
      .toThrow(/authority evidence is inconsistent/u);
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(crossBoundToAnotherChainGeneration))
      .toThrow(/authority evidence is inconsistent/u);
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(unprojectedAuthority))
      .toThrow(/unknown or missing fields/u);

    const droppedOutsiderInventory = structuredClone(artifact);
    droppedOutsiderInventory.outsider.graphCounts.pop();
    expect(() => decodeRfc64PrivateGatePassArtifactV2(droppedOutsiderInventory))
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(missingCatalog))
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(missingRevokedInventory))
      .toThrow(/graph inventory differs/u);
    ...
    nonAdvancingRoster.revokedReceiver.authority.providerObservation
      .previousChainRosterVersion = '1';
    expect(() => decodeRfc64PrivateGatePassArtifactV2(nonAdvancingRoster))
      .toThrow(/authority evidence is inconsistent/u);
    ...
    consistentlyReboundReceiver.revokedReceiver.authority.providerObservation.revokedAgentAddress =
      unrelatedAddress;
    expect(() => decodeRfc64PrivateGatePassArtifactV2(consistentlyReboundReceiver))
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(missingSourceProof))
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(crossCatalogState))
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(extraNestedState))
      .toThrow(/unknown or missing fields/u);
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(reboundBootstrap))
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(extraBootstrapField))
      .toThrow(/unknown or missing fields/u);
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(reorderedFailover))
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(reboundRpc))
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(unknownRpcMethod))
      .toThrow(/malformed method accounting/u);
    ...
    expect(hasExactMemoryContents({
      appliedHeadDigest: rewrittenMemory.provider2.appliedHeadDigest,
      catalogVersion: rewrittenMemory.provider2.catalogVersion,
      exactExpectedHead: true,
      graphCounts: rewrittenMemory.provider2.graphCounts,
    })).toBe(false);
    expect(() => decodeRfc64PrivateGatePassArtifactV2(rewrittenMemory))
      .toThrow(/SWM projection differs/u);
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(finalizedSourceVm))
      .toThrow(/unexpected VM head evidence/u);
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(materializedSourceVm))
      .toThrow(/VM projection differs/u);
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(reboundBaseline))
      .toThrow(/not bound to the catalog/u);
    const changedLimitation = structuredClone(artifact);
    changedLimitation.limitation = 'unbounded external RPC';
    expect(() => decodeRfc64PrivateGatePassArtifactV2(changedLimitation))
    ...
    expect(() => decodeRfc64PrivateGatePassArtifactV2(consistentlyReboundScope))
      .toThrow(/not fixture-bound/u);
    ...
    consistentlyReboundPolicy.revokedReceiver.authority.providerObservation.policyDigest =
      unrelatedPolicyDigest;
    expect(() => decodeRfc64PrivateGatePassArtifactV2(consistentlyReboundPolicy))
      .toThrow(/not fixture-bound/u);
  });
  ...
  it('accepts exact SHA-1/SHA-256 revisions and rejects other revision widths or future intervals', () => {
    ...
    expect(decodeRfc64PrivateGatePassArtifactV2(sha256Artifact)).toBe(sha256Artifact);
    expect(() => decodeRfc64PrivateGatePassArtifactV2({
  ...
  it('rejects PASS provenance with a missing revision or invalid run interval', () => {
    ...
    expect(() => assertRfc64PrivateGatePassProvenanceV2({
      ...base,
      sourceRevision: null,
  ...
  it('rejects every mutation of the fixed eleven-process topology', () => {
