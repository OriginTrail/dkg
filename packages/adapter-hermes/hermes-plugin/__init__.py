...
DKG_ASSERTION_SHARE_SCHEMA = {
    ...
    "description": (
        ...
        "the asset on-chain (Verifiable Memory). The auto-seal uses DEFAULT attestation settings; "
        "if you need CUSTOM finalize options (author_agent_address / scheme_version) call "
        "dkg_knowledge_asset_finalize EXPLICITLY first, even for a full share. A SELECTIVE subset (`entities` set to a proper "
