...
const REQUIRED_FILES = [
  ...
  'component/interfaces/origintrail-semantic-runtime-asset-create.d.ts',
  'component/interfaces/origintrail-semantic-runtime-sparql-read.d.ts',
  'component/interfaces/origintrail-semantic-runtime-safe-llm.d.ts',
  'component/interfaces/origintrail-semantic-runtime-remote-execute.d.ts',
