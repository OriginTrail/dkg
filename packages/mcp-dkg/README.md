...
- **WSL2: daemon dies when the terminal closes** → wrap in `tmux` or install as a systemd user service. The current operator docs cover daemon lifecycle at [Daemon Lifecycle](../../docs/operate/daemon.md).
