...
export function generateKCMetadata(
  ...
  quads.push(
    ...
    // V10 Axiom 1 + 4 evidence: keep the legacy `dkg:paranet` predicate so
    // existing consumers (and the axiom-checks suite) continue to find the
    // CG-binding link via either name.
