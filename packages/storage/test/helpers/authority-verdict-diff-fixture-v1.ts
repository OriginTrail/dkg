...
export const CORE_QUARANTINE_REASONS_V1 = {
  'head-fork': { sites: [260, 271, 641] },
  'transition-equivocation': { sites: [211, 243, 609, 708, 733, 789, 792] },
} as const;
...
export const CORE_REJECT_REASON_SITES_V1: Readonly<Record<string, readonly number[]>> = {
  'absent state cannot retain authority history or quarantine': [291, 760],
  'accepted authority state has incomplete transition lineage': [195, 771],
  'accepted head does not bind its retained transition lineage': [204],
  'active closure contains tombstone-only authority evidence': [339],
  'authority history is incomplete': [223],
  'authority transition reuses a root retained by this record': [590, 806],
  'cold noninitial head requires its verified authority closure': [308],
  'cold tombstone closure lacks its exact deletion predecessor': [330],
  'current frontier fork requires its exact direct resolving successor': [687],
  'exact accepted authority transition is missing': [569],
  'fork resolution issuedAt exceeds the future clock-skew bound': [693],
  'head issuedAt exceeds the future clock-skew bound': [159],
  'historical or unsolicited fork resolution is audit-only': [664],
  'late tombstone entry requires a candidate below the accepted authority sequence': [531],
  'late tombstone entry requires a tombstone candidate': [522],
  'late tombstone lacks its exact verified active predecessor': [386],
  'late tombstone requires the exact retained resurrection transition': [404],
  'next-sequence head does not bind transition issuer/root': [599],
  'next-sequence tombstone requires its exact same-sequence active predecessor': [575],
  'same-sequence authority changed': [239],
  'stable record key changed': [208, 778],
  'tombstone is terminal within its authority sequence': [264],
  'tombstone lacks its exact verified active predecessor': [636],
  'transition has no accepted predecessor': [765],
  'transition verification time is invalid': [747],
  'transitions do not target the same authority tuple': [727],
  'unresolved head fork cannot advance authority sequence': [554, 797],
  'verification clock is invalid': [154],
  'verified authority closure has incomplete lineage': [318],
};
