...
export const VERDICT_DIFF_COUNTERFACTUALS_V1: readonly VerdictDiffCounterfactualV1[] = [
  {
    site: 'packages/storage/src/system-record-next-state-v1-internal.ts:1253',
 ...
 * through an allowlist at system-record-authority-v1-internal.ts:836, so it
...
export const CORE_SUMMARY_ASYMMETRY_CITATIONS_V1: readonly SourceCitationV1[] = [
  {
    ...
    site: 'packages/core/src/system-record-authority-v1-internal.ts:279',
  ...
  },
  {
    ...
    site: 'packages/core/src/system-record-authority-v1-internal.ts:836',
...
export const CORE_SWEEP_FINDINGS_V1: readonly string[] = [
  ...
  + 'the field, at system-record-authority-v1-internal.ts:279, inside the ABSENT-state '
