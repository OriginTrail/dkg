...
import { resolveEpcisEventType, compactEpcisEventType } from '../src/epcis-vocabulary.js';
...
it.each([
  ...
  { input: 'CustomEvent', kind: 'legacy-gs1-extension', iri: 'https://gs1.github.io/EPCIS/CustomEvent', response: 'CustomEvent' },
