...
Faucet funding is best-effort: a failed call logs a manual `curl` block and setup continues. See the main repo's [Testnet Funding](../../README.md#testnet-funding) section and [Funding](../../docs/operate/funding.md) for the current operational guidance.
