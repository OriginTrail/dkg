...
/** Exact reserved tuple response, including a maximum 256-KiB subject table and JSON overhead. */
export const SYSTEM_RECORD_MAX_ATOMIC_RESERVED_INSPECTION_RESPONSE_BYTES = 1024 * 1024;
/** Largest encoded SPARQL JSON inspection body retained before strict decoding. */
export const SYSTEM_RECORD_MAX_ATOMIC_INSPECTION_RESPONSE_BYTES = 4 * 1024 * 1024;
export const SYSTEM_RECORD_MAX_ATOMIC_SPARQL_REQUEST_BYTES = 4 * 1024 * 1024;
/** Storage-local retained command/query/update/receipt buffers for one apply. */
export const SYSTEM_RECORD_MAX_ATOMIC_PREPARED_BYTES = 8 * 1024 * 1024;
...
export const SYSTEM_RECORD_NEGATIVE_MEMO_TTL_MS = 30_000;
export const SYSTEM_RECORD_MAX_NEGATIVE_MEMO_ENTRIES = 1_024;
/** Fixed JS control-state charge in addition to the UTF-8 memo key bytes. */
export const SYSTEM_RECORD_NEGATIVE_MEMO_ENTRY_BASE_BYTES = 128;
...
export const SYSTEM_RECORD_APPLY_TIMEOUT_MS = SYSTEM_RECORD_MATERIALIZER_HARD_TIMEOUT_MS;
export const SYSTEM_RECORD_INSPECTION_TIMEOUT_MS = 1_000;
export const SYSTEM_RECORD_REQUIRED_DISPATCH_BUDGET_MS = 1_500;
