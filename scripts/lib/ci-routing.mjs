...
const IDENTITY_WALLET_EVM_PATTERNS = [
  ...
  /^packages\/cli\/src\/(?:daemon\/http-utils|auth|boolean-env-override|config|durable-file-replace|file-lock|home-config-file|oxigraph-memory-limits|runtime-assets)\.ts$/,
];
...
export const PATH_TRIGGERS = Object.freeze([
  ...
  {
    patterns: [/^packages\/cli\/src\/(?:auth|boolean-env-override|config|durable-file-replace|file-lock|home-config-file|oxigraph-memory-limits|runtime-assets)\.ts$/],
