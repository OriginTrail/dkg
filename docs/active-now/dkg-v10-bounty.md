...
* Integrations that touch _only_ **Verifiable Memory** or chain-anchoring flows. These are the subject of a later round. Submissions that primarily target Working and Shared Memory but deliberately anticipate promotion to Verifiable Memory and consumption by context oracles are in scope and, per section 9, scored higher for it.
