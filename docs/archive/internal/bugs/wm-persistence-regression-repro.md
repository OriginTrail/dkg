# Graphify Import Fixes — Reproduction Guide
...
- **Phase 1 (DONE)** — Reproduce the WM persistence regression and document it.
  Artefacts: this guide, `scripts/repro/wm-persistence-regression.mjs`,
  `docs/archive/internal/bugs/wm-persistence-regression.md`, and the matrix evidence under
  `.dkg-repro-reports/matrix-20260525-092823.json`.
- **Phase 2** — Fix the WM persistence regression itself. Tracked in a follow-up
  PR; see `docs/archive/internal/bugs/wm-persistence-regression.md` "Suggested fix shape".
