// Dashboard catalog for the DKG observability Grafana — DATA ONLY (panel
// definitions, node-identity discovery model, row layout). Rendering,
...
export const buildDashboards = ({ PROM_NODE_LABEL }) => {
  ...
  return { fleet, nodeLogs, metrics, traces };
};
