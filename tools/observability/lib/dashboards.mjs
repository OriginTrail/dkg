    ...
    [
      ...
      { w: 18, h: 9, def: {
        ...
        targets: [{
          datasource: LOKI,
          refId: 'A',
          expr: `sum by (service_instance_id) (count_over_time(${FE} [2m]))`,
