...
| I2 | `dkg.sync.attempt.request_bytes` | counter | `By` | `dkg_sync_attempt_request_bytes`<br>`dkg_sync_attempt_request_bytes_total` | `transport`, `plane`, `phase`, `source` |
| I3 | `dkg.sync.attempt.response_bytes` | counter | `By` | `dkg_sync_attempt_response_bytes`<br>`dkg_sync_attempt_response_bytes_total` | `transport`, `plane`, `phase`, `source`, `outcome` |
